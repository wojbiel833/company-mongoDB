...
describe("Department", () => {
  ...
  describe("Reading data", () => {
    ...
    describe("Creating data", () => {
      ...
      //     const savedDepartment = await Department({ name: "Department #1" });
      //     expect(savedDepartment).not.to.be.null;
      //   });
      // LUB TAK
      it('should insert new document with "insertOne" method', async () => {
        const department = new Department({ name: "Department #1" });
    ...
    describe("Updating data", () => {
      ...
      //     expect(updatedDepartments[0].name).to.be.equal("!Updated!");
      //     expect(updatedDepartments[1].name).to.be.equal("!Updated!");
      //   });
      // LUB TAK
      it('should properly update multiple documents with "updateMany" method', async () => {
        await Department.updateMany({}, { $set: { name: "Updated!" } });
